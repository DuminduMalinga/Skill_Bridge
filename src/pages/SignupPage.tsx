            ...
            <div className="lg:col-span-6 flex flex-col justify-between p-space-lg sm:p-space-xl">
              <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-space-xs mb-space-lg">
                  <div className="inline-flex items-center justify-between self-start gap-2 px-3 py-1 mb-1 rounded-full bg-secondary-container/40 border border-outline-variant/30 text-body-sm">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="font-label-sm text-on-surface-variant">
                        Signing up as a <strong className="text-on-surface font-semibold">Student</strong>
                      </span>
                    </div>
                  ...
                  <h1 className="font-headline-lg text-headline-lg text-on-surface tracking-tight">Create your student account</h1>
                  <p className="font-body-md text-body-md text-on-surface-variant">
                    Bridge your academic coursework to verified, real-world industry experience.
                  </p>
                </div>
                <form className="flex flex-col gap-space-md" onSubmit={(e) => e.preventDefault()}>
                  <div className="flex flex-col gap-1.5">
                    <label className="font-label-md text-label-md text-on-surface font-semibold" htmlFor="full_name">Full Name</label>
                    <div className="relative">
                      <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-secondary text-[20px] pointer-events-none">person</span>
                      <input
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="font-label-md text-label-md text-on-surface font-semibold" htmlFor="email">University Email</label>
                    <div className="relative">
                      <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-secondary text-[20px] pointer-events-none">school</span>
                      <input
                        className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-surface text-on-surface font-body-md text-body-md placeholder-secondary focus:outline-none focus:bg-surface-container-lowest focus:ring-2 focus:ring-primary-container/25 transition-all shadow-sm"
                        id="email"
                    ...
                    <p className="font-caption text-caption text-secondary flex items-center gap-1 mt-0.5">
                      ...
                      Use your .edu or university domain for instant verification
                    </p>
                  </div>
                  <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex items-start gap-2.5 mt-1">
                    ...
                    <label className="font-caption text-caption text-on-surface-variant select-none" htmlFor="terms">
                      I agree to SkillBridge <a className="text-primary hover:underline" href="#">Terms of Service</a> &amp; <a className="text-primary hover:underline" href="#">Privacy Policy</a>
                    </label>
                  </div>
                  <button
              ...
              <div className="mt-space-lg pt-space-sm flex items-center justify-center text-center">
                <span className="font-caption text-caption text-secondary flex items-center gap-1.5">
                  ...
                  256-bit encrypted • Partnered with 85+ accredited universities
                </span>
              </div>
            </div>
              ...
              <div className="relative z-10 flex items-center justify-between gap-2 flex-wrap">
                <div className="inline-flex items-center gap-2 bg-surface-container-lowest/80 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-sm">
                  <div className="flex -space-x-1.5 items-center">
                    <span className="w-5 h-5 rounded-full bg-primary text-on-primary flex items-center justify-center font-caption text-[9px] font-bold">AU</span>
                    ...
                    <span className="w-5 h-5 rounded-full bg-secondary text-on-secondary flex items-center justify-center font-caption text-[9px] font-bold">OX</span>
                  </div>
                  <span className="font-caption text-caption text-on-surface font-medium">Joined by 2,400+ ambitious students</span>
                </div>
              ...
              <div className="relative my-space-md flex flex-col items-center justify-center z-10">
                ...
                <div className="absolute -top-4 -left-2 sm:-left-6 bg-surface-container-lowest/90 backdrop-blur-md p-space-sm rounded-lg shadow-lg flex items-center gap-3 max-w-[210px]">
                  ...
                  <div className="min-w-0">
                    <div className="font-label-sm text-label-sm text-on-surface truncate font-semibold">Gap Calibration</div>
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <span className="font-caption text-caption font-bold text-tertiary">78% Ready</span>
                ...
                <div className="absolute -bottom-4 -right-2 sm:-right-6 bg-surface-container-lowest/90 backdrop-blur-md p-space-sm rounded-lg shadow-lg flex flex-col gap-1.5 max-w-[220px]">
                  <div className="flex items-center justify-between gap-2">
                    <span className="font-label-sm text-label-sm text-on-surface font-semibold">Industry Sprints</span>
                    <span className="font-caption text-[11px] text-primary font-medium">Live</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-0.5 rounded bg-surface text-secondary font-label-sm text-[11px] font-semibold">Nimbus Pay</span>
                    <span className="px-2 py-0.5 rounded bg-surface text-secondary font-label-sm text-[11px] font-semibold">Ledgerly</span>
                    <span className="px-2 py-0.5 rounded bg-surface text-secondary font-label-sm text-[11px] font-semibold">Figma</span>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col">
                    <p className="font-body-sm text-body-sm text-on-surface italic">
                      &ldquo;SkillBridge helped me turn abstract lecture theory into tangible production code that got me hired.&rdquo;
                    </p>
                    <div className="mt-2 flex items-center justify-between">
                      <span className="font-label-sm text-label-sm text-on-surface font-semibold">Maya Chen</span>
                      <span className="font-caption text-caption text-secondary">Associate Engineer @ Nimbus Pay</span>
                    </div>
                  </div>
                </div>
              </div>
