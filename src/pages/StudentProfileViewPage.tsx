...
export default function StudentProfileViewPage() {
  ...
  return (
    <div className="bg-surface font-body-md text-on-surface antialiased min-h-screen">
      <header className="w-full h-16 bg-surface-container-lowest shadow-[0_1px_8px_rgba(0,0,0,0.04)] px-8 flex items-center justify-between">
        <div className="flex items-center gap-space-sm">
          ...
          <span className="px-2 py-0.5 rounded-full bg-secondary-container text-on-secondary-container font-label-sm text-[11px] font-semibold tracking-wide uppercase">Partner</span>
        </div>
        <Link to="/applicant-review" className="inline-flex items-center gap-1.5 text-on-surface-variant hover:text-primary font-label-md text-label-md transition-colors">
          <span className="material-symbols-outlined text-[18px]">arrow_back</span>
          <span>Back to Applicant Review</span>
        </Link>
      </header>

      <main className="relative w-full px-8 bg-surface min-h-screen">
        <div className="max-w-7xl w-full mx-auto pb-16">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-5 mb-2">
            <div className="flex items-center gap-2 font-label-md text-label-md text-on-surface-variant">
              <Link className="inline-flex items-center gap-1.5 hover:text-primary transition-colors" to="/applicant-review">
                <span className="material-symbols-outlined text-[18px]">arrow_back</span>
                <span>Back to Applicant Review</span>
              </Link>
              <span className="material-symbols-outlined text-[16px] text-outline">chevron_right</span>
              <span className="text-on-surface font-semibold">Student Profile (Read-only)</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-secondary-container/60 text-on-secondary-fixed-variant font-label-sm text-label-sm font-semibold">
                <span className="material-symbols-outlined text-[16px]">visibility</span>
                <span>Viewing as Company Reviewer</span>
              </span>
              ...
              <div className="bg-surface-container-lowest rounded-2xl p-6 sm:p-7 shadow-[0_1px_3px_0_rgba(0,0,0,0.04)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5">
                  {VERIFIED_SKILLS.map((skill) => (
                    <div key={skill.title} className="relative flex items-start justify-between p-3.5 rounded-xl bg-surface hover:bg-surface-container-low transition-all">
                      ...
                      <span className="px-2 py-0.5 rounded-full font-label-sm text-label-sm bg-secondary-container/50 text-tertiary shrink-0">{skill.level}</span>
                    </div>
                  ))}
                </div>
              </div>
              <div className="bg-surface-container-lowest rounded-2xl p-6 sm:p-7 shadow-[0_1px_3px_0_rgba(0,0,0,0.04)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5">
                  {IN_PROGRESS_SKILLS.map((skill) => (
                    <div key={skill.title} className="flex flex-col justify-between p-3.5 rounded-xl bg-surface hover:bg-surface-container-low transition-all">
