      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full px-gutter-sm lg:px-margin py-space-lg">
        <div className="flex flex-col w-full max-w-7xl mx-auto my-auto items-center justify-center py-space-md">
          <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-space-lg lg:gap-space-xl items-stretch bg-surface-container-lowest rounded-xl shadow-xl overflow-hidden min-h-[720px]">
            <div className="lg:col-span-6 flex flex-col justify-between p-space-lg sm:p-space-xl">
              <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-space-xs mb-space-lg">
                  <div className="inline-flex items-center justify-between self-start gap-2 px-3 py-1 mb-1 rounded-full bg-secondary-container/40 border border-outline-variant/30 text-body-sm">
                    <div className="flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-primary" />
                      <span className="font-label-sm text-on-surface-variant">
                        Signing up as a <strong className="text-on-surface font-semibold">Company</strong>
                      </span>
                    </div>
                  ...
                  <h1 className="font-headline-lg text-headline-lg text-on-surface tracking-tight">Create your company account</h1>
                  <p className="font-body-md text-body-md text-on-surface-variant">
                    Publish real engineering briefs, mentor emerging talent, and recruit pre-verified graduates.
                  </p>
                </div>
                <form className="flex flex-col gap-space-md" onSubmit={(e) => e.preventDefault()}>
                  <div className="flex flex-col gap-1.5">
                    <label className="font-label-md text-label-md text-on-surface font-semibold" htmlFor="company_name">Company Name</label>
                    <div className="relative">
                      <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-secondary text-[20px] pointer-events-none">domain</span>
                      <input
                        ...
                        id="company_name"
                        placeholder="e.g. Nimbus Pay Technologies"
                        required
                        type="text"
                      />
                    </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-surface text-on-surface font-body-md text-body-md placeholder-secondary focus:outline-none focus:bg-surface-container-lowest focus:ring-2 focus:ring-primary-container/25 transition-all shadow-sm"
                        id="email"
                        placeholder="e.g. sarah.jenkins@nimbuspay.com"
                        required
                        type="email"
                      />
                    </div>
                    <p className="font-caption text-caption text-secondary flex items-center gap-1 mt-0.5">
                      ...
                      Use your company domain for instant partner verification
                    </p>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-space-md">
                    <div className="flex flex-col gap-1.5">
                      <label className="font-label-md text-label-md text-on-surface font-semibold" htmlFor="industry">Industry</label>
                      <div className="relative">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="font-label-md text-label-md text-on-surface font-semibold" htmlFor="company_size">Company Size</label>
                      <div className="relative">
                        <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-secondary text-[20px] pointer-events-none">groups</span>
                        <select
                          className="w-full pl-10 pr-9 py-2.5 rounded-lg bg-surface text-on-surface font-body-md text-body-md appearance-none focus:outline-none focus:bg-surface-container-lowest focus:ring-2 focus:ring-primary-container/25 transition-all shadow-sm cursor-pointer"
                          id="company_size"
                          required
                        ...
                        >
                          ...
                          <option>Seed / Early Stage (1–10)</option>
                          <option>Growth Stage (11–50)</option>
                          <option>Mid-Market (51–250)</option>
                          <option>Enterprise (250–1,000)</option>
                          <option>Global Tech Enterprise (1,000+)</option>
                        </select>
                        <span className="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-secondary text-[18px] pointer-events-none">expand_more</span>
                      </div>
                    </div>
                  ...
                  <div className="flex items-start gap-2.5 mt-1">
                    ...
                    <label className="font-caption text-caption text-on-surface-variant select-none" htmlFor="terms">
                      I agree to SkillBridge <a className="text-primary hover:underline" href="#">Company Agreement</a> &amp; <a className="text-primary hover:underline" href="#">Privacy Policy</a>
                    </label>
                  </div>
                  <button
            ...
            <div className="lg:col-span-6 relative bg-gradient-to-br from-primary-fixed/40 via-surface-container-low to-surface-container flex flex-col justify-between p-space-lg sm:p-space-xl overflow-hidden">
              <div className="absolute -top-16 -right-16 w-80 h-80 rounded-full bg-primary-fixed blur-3xl opacity-40 pointer-events-none" />
              <div className="absolute -bottom-20 -left-12 w-80 h-80 rounded-full bg-tertiary-fixed blur-3xl opacity-30 pointer-events-none" />
              <div className="relative z-10 flex items-center justify-between gap-2 flex-wrap">
                <div className="inline-flex items-center gap-2 bg-surface-container-lowest/80 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-sm">
                  <div className="flex -space-x-1.5 items-center">
                    <span className="w-5 h-5 rounded-full bg-primary text-on-primary flex items-center justify-center font-caption text-[9px] font-bold">MZ</span>
                    <span className="w-5 h-5 rounded-full bg-tertiary text-on-tertiary flex items-center justify-center font-caption text-[9px] font-bold">ST</span>
                    <span className="w-5 h-5 rounded-full bg-secondary text-on-secondary flex items-center justify-center font-caption text-[9px] font-bold">FG</span>
                  </div>
                  <span className="font-caption text-caption text-on-surface font-medium">Joined by 85+ verified industry partners</span>
                </div>
              ...
              <div className="relative my-space-md flex flex-col items-center justify-center z-10">
                ...
                <div className="absolute -top-4 -left-2 sm:-left-6 bg-surface-container-lowest/90 backdrop-blur-md p-space-sm rounded-lg shadow-lg flex items-center gap-3 max-w-[210px]">
                  ...
                  <div className="min-w-0">
                    <div className="font-label-sm text-label-sm text-on-surface truncate font-semibold">Skill-Matched Pipeline</div>
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <span className="font-caption text-caption font-bold text-tertiary">94% Overlap</span>
                      <span className="w-1.5 h-1.5 rounded-full bg-tertiary" />
                      <span className="font-caption text-[10px] text-secondary">CS Core</span>
                    </div>
                  </div>
                </div>
                <div className="absolute -bottom-4 -right-2 sm:-right-6 bg-surface-container-lowest/90 backdrop-blur-md p-space-sm rounded-lg shadow-lg flex flex-col gap-1.5 max-w-[220px]">
                  <div className="flex items-center justify-between gap-2">
                    <span className="font-label-sm text-label-sm text-on-surface font-semibold">Verified Talent</span>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 rounded bg-surface text-secondary font-label-sm text-[11px] font-semibold">Kingswell College</span>
                    <span className="px-2 py-0.5 rounded bg-surface text-secondary font-label-sm text-[11px] font-semibold">Elmsworth University</span>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col">
                    <p className="font-body-sm text-body-sm text-on-surface italic">
                      &ldquo;SkillBridge cut our graduate sourcing time by 60% and every candidate arrived with verified, production-grade proof of work.&rdquo;
                    </p>
                    <div className="mt-2 flex items-center justify-between">
                      <span className="font-label-sm text-label-sm text-on-surface font-semibold">Sarah Jenkins</span>
                      <span className="font-caption text-caption text-secondary">Talent Director @ Nimbus Pay</span>
                    </div>
                  </div>
                </div>
              </div>
